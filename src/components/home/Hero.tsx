  ...
  return (
    <section className="relative h-[85vh] w-full overflow-hidden">
      ...
      <div className="relative flex h-full flex-col items-center justify-center text-center text-white px-6">
        ...
        <h1 className="font-display mb-6 text-4xl font-medium leading-tight tracking-tight sm:text-6xl md:text-7xl lg:text-8xl drop-shadow-sm">
          {t.hero.heading} <br />
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <Link
            href="/portfolio"
            className="rounded-lg bg-white px-8 py-3.5 text-sm font-bold uppercase tracking-wider text-slate-900 transition-all hover:bg-sand hover:shadow-2xl cursor-pointer"
          >
            {t.hero.cta}
          </Link>
        </div>
